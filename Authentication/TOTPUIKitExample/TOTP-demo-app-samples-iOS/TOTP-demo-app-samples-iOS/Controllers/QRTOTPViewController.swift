...
class QRTOTPViewController: UIViewController {
    ...
    private func fetchAndMapSavedTOTPToCellModel() {
        let savedItems = DataManager.shared.fetchItems(forType: .qr)
...
extension QRTOTPViewController: QRCodeScannerDelegate {
    ...
    func didRecieveTOTPInfo(_ totpInfo: DataManager.TOTPInfo?) {
        ...
        DataManager.shared.addItem(totpInfo, type: .qr)
        
    }
    
}

extension QRTOTPViewController: UITableViewDelegate, UITableViewDataSource {
