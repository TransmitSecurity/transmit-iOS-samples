...
enum VCNames: String {
    case MainViewController, QRCodeScannerViewController, RegisterTOTPViewController, HomePageViewController, LoginViewController, LoaderViewController, SilentTOTPViewController
}
